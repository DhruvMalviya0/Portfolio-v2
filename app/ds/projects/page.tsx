...
export default function DSProjectsPage() {
  return (
    <main className="persona-stage">
      ...
      <div className="title-block">
        <span className="eyebrow">DATA SCIENCE REALM · PROJECTS</span>
        <div className="title font-display">PROJECTS</div>
      </div>
      ...
      >
        ...
        >
          Content coming in Phase 3. The path of ORACLE.
        </p>
      </div>
      ...
      <div className="menu" style={{ top: "65%" }}>
        ...
        >
          ...
          <span className="menu-label font-display">RETURN TO ORACLE</span>
        </TransitionLink>
      </div>
