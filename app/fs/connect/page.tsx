...
export default function FSConnectPage() {
  return (
    <main className="persona-stage">
      ...
      <div className="title-block">
        <span className="eyebrow">FULL-STACK REALM · CONNECT</span>
      ...
      >
        ...
        >
          Content coming in Phase 3. The path of FORGE.
        </p>
      </div>
      ...
      <div className="menu" style={{ top: "65%" }}>
        ...
        >
          ...
          <span className="menu-label font-display">RETURN TO FORGE</span>
        </TransitionLink>
      </div>
